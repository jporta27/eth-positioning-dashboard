...
Related: [[Regime classifier (HMM K=4)]] (a structural slower signal), [[Z-score (CEX netflows)]] (one of the inputs), [[Market State Score - Quant Review]] (validation plan + improvement priorities), [[Market State Score - Empirical Findings]] (60d backtest results — **flag**: partial 6/12 reconstruction shows anti-predictive signal, inversion test confirms semantic mapping may be reversed)
